...
Tables are created automatically on first request, and the 47 seeded decisions are loaded
...
```bash
npm install
npm test        # 44 tests over the checks, hashing, replay and concurrency
npm run dev
```
